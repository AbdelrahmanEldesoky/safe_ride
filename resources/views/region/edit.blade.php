                            ...
                            <div class="row">
                                @foreach(config('translatable.locales') as $locale)
                                    <div class="form-group col-md-4">
                                        {{ Form::label("name[$locale]", __('message.name').' ('.__('ride.'.$locale).') <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                        {{ Form::text("name[$locale]", $data->getTranslation('name', $locale), ['placeholder' => __('message.name'), 'class' => 'form-control', 'required']) }}
                                    </div>
                                @endforeach
