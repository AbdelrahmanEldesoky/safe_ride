                        ...
                        @else
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex flex-xl-row flex-column justify-content-between align-items-center align-items-xl-start px-0">
                                    <span>{{ __('message.amount') }}</span>
                                    <span
                                        class="font-weight-bold">{{ optional($data->payment)->total_amount == null ? '-' : getPriceFormat(optional($data->payment)->total_amount) }}</span>
                                </li>
                            </ul>
                        @endif
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card card-block">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3">
                                <img src="{{ getSingleMedia(optional($data->rider), 'profile_image',null) }}"
                                     alt="rider-profile" class="img-fluid avatar-60 rounded-small">
                            </div>
                            <div class="col-9">
                                ...
                                @else
                                    <p class="mb-0"><b>{{ __('message.booked_by') }}
                                            :</b> {{ optional($data->rider)->display_name }}</p>
                ...
                @if( isset($data->driver) )
                    <div class="card card-block">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <img src="{{ getSingleMedia(optional($data->driver), 'profile_image',null) }}"
                                         alt="driver-profile" class="img-fluid avatar-60 rounded-small">
                                </div>
                                <div class="col-9">
                ...
                <div class="card card-block">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title mb-0">{{ __('message.booking_type') }}</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3">
                                <p class="mb-0">{{__('message.'.$data->booking_type) }}</p>
                            </div>
                            <div class="col-9">
                                @if($data->booking_type == 'schedule')
                                    <p class="mb-0">
                                        {{ \Carbon\Carbon::parse($data->from_date)->format('Y-m-d H:i') }}
                                    </p>
