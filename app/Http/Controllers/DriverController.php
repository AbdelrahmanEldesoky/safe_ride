...
class DriverController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('driver.form', compact('pageTitle', 'assets', 'services'));
    }
    ...
    public function show(WalletHistoryDataTable $dataTable, $id)
    {
        ...
        $documentIDS = DriverDocument::where('driver_id', $id)->pluck('document_id')->ToArray();
        $documents = Document::whereIn('id', $documentIDS)->get();

        return $dataTable->with('user_id', $id)->render('driver.show', compact('pageTitle', 'data', 'profileImage', 'pageTitle', 'documents'));
    }
    ...
    public function edit($id)
    {
        ...
        */
        return view('driver.form', compact('data', 'pageTitle', 'id', 'profileImage', 'services', 'assets'));
    }
