...
{
    use HasApiTokens, HasFactory, Notifiable, HasRoles, InteractsWithMedia, HasTranslations;
    ...
    protected $fillable = [
        ...
        'service_id', 'is_verified_driver', 'last_location_update_at', 'front_image', 'back_image','verify_code','verify_check'
    ];
